function Contact() {
  return (
    ...
    >
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 auto-rows-fr">

        {/* LEFT SIDE — BLUE CARD */}
        <div
          className="bg-[#162456] text-white rounded-2xl shadow-xl 
                     px-10 pt-10 
                     flex flex-col 
                     h-full"
        >
          ...
          {/* DOODLE — PROPERLY STUCK TO BOTTOM */}
        ...
        {/* RIGHT SIDE — FORM */}
        <form
          action="https://formspree.io/f/mykdeovq"
          method="POST"
          className="bg-white border border-[#0f2d5c]/10 shadow-xl rounded-2xl p-8 space-y-6 h-full"
        >
          <div>
